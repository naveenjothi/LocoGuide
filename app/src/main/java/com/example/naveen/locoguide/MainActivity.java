...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_canteen) {
            ...
            fragmentManager.beginTransaction().replace(R.id.Fragment,First);

        }else if (id == R.id.nav_teashop) {
        ...
        } else if (id == R.id.nav_dept1) {
            Third third=new Third();
            android.support.v4.app.FragmentManager fragmentManager=getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.Fragment, third).commit();


        }else if (id == R.id.nav_dept2) {
            Intent intent=new Intent(MainActivity.this,location.class);
            startActivity(intent);


        }else if (id == R.id.nav_dept3) {

        }
        else if (id == R.id.nav_dept4) {

        }
        else if (id == R.id.nav_dept5) {


        }
        else if (id == R.id.nav_dept6) {

        }
        else if (id == R.id.nav_dept7) {

        }
        else if (id == R.id.nav_dept8) {

        }
        else if (id == R.id.nav_dept9) {
