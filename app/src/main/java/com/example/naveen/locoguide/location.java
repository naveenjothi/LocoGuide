...
public class location extends AppCompatActivity implements
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(new LatLng(10.416957, 77.900612)).title("Statue of liberty").snippet("i hope to go there"));
    ...
    private void showDefaultLocation() {
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLng(redmond));
    }
    ...
    private GoogleMap.OnMyLocationClickListener onMyLocationClickListener =
            new GoogleMap.OnMyLocationClickListener() {
                ...
                public void onMyLocationClick(@NonNull Location location) {
                    ...
                    mMap.setOnMyLocationClickListener((point)-> {
                            ...
                            if (MarkerPoints.size() >= 2) {
                                ...
                                LatLng dest = new LatLng(10.416957, 77.900612);

                                // Getting URL to the Google Directions API
                                String url = getUrl(origin, dest);
                                Log.d("onMapClick", url.toString());
                                location.FetchUrl FetchUrl = new location.FetchUrl();
    ...
    public class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                lineOptions.add(new LatLng(10.416957, 77.900612));
